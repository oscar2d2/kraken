...
func (_m *MockIntervalTask) EXPECT() *MockIntervalTaskMockRecorder {
	return _m.recorder
}

// Run mocks base method
func (_m *MockIntervalTask) Run() {
	_m.ctrl.Call(_m, "Run")
}

// Run indicates an expected call of Run
func (_mr *MockIntervalTaskMockRecorder) Run() *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "Run", reflect.TypeOf((*MockIntervalTask)(nil).Run))
}
